...
public class LocalSearch{
    ...
    public LocalSearch(ArrayList<Student> students, ArrayList<Spot> spots){
        ...
        for (int x = 0; x < students.size(); x++){
            ...
            Spot spot = spots.get(x);
            student.setSpot(spot);
            student.setCurrDist(findDist(student, spot));
            spot.setState(true);
            totaldistance += findDist(student, spot);
        }
        double initialdistance = totaldistance + 1;
        //System.out.println(totaldistance);
        while(totaldistance < initialdistance){
            initialdistance = totaldistance;
            for (int i = 0; i < students.size(); i++){
                for (int j = i + 1; j < students.size(); j++){
                    Student student1 = students.get(i);
                    Student student2 = students.get(j);
                    Spot spot1 = student1.getSpot();
                    Spot spot2 = student2.getSpot();
                    double tempdistance = totaldistance;
                    tempdistance = tempdistance - student1.getCurrDist() - student2.getCurrDist();
                    if ((tempdistance + findDist(student1, spot2) + findDist(student2, spot1)) < totaldistance){
                        student1.setSpot(spot2);
                        student2.setSpot(spot1);
                        student1.setCurrDist(findDist(student1, spot2));
                        student2.setCurrDist(findDist(student2, spot1));
                        totaldistance = tempdistance + findDist(student1, spot2) + findDist(student2, spot1);
                        break;
                    }
                }
            }
        ...
        //String filename = "localsearch.csv";
