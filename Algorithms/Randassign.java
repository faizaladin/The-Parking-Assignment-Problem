...
public class Randassign{
    ...
    public Randassign(List<Student> students, List<Spot> spots){
        ...
        System.out.println(" ");
        System.out.println("Average Walking Distance for Student: " + ((grade1dist + grade2dist + grade3dist + grade4dist)/students.size()));
